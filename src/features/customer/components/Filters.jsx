...
import { clear_filter_store } from '../../../store/customerStore/customerStore';
import { set_filter_store_thunk, get_filter_thunk } from '../../../store/customerStore/customerThunks';
import {
...
export default function CustomerFilters({ resultCount }) {
  const dispatch = useDispatch();
  const { filter_search, filter_status, filter_deleted } = useSelector((s) => s.customerStore);
