...
import { clear_filter_store } from '../../../store/brandStore/brandStore';
import { set_filter_store_thunk, get_filter_thunk } from '../../../store/brandStore/brandThunks';
import {
...
export default function BrandFilters({ resultCount }) {
  const dispatch = useDispatch();
  const { filter_search, filter_status, filter_deleted } = useSelector((s) => s.brandStore);
