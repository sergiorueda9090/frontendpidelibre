...
import { clear_filter_store } from '../../../store/featureAreaStore/featureAreaStore';
import { set_filter_store_thunk, get_filter_thunk } from '../../../store/featureAreaStore/featureAreaThunks';
import {
...
export default function FeatureAreaFilters({ resultCount }) {
  const dispatch = useDispatch();
  const { filter_search, filter_status, filter_deleted } = useSelector((s) => s.featureAreaStore);
