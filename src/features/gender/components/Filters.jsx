...
import { clear_filter_store } from '../../../store/genderStore/genderStore';
import { set_filter_store_thunk, get_filter_thunk } from '../../../store/genderStore/genderThunks';
import {
...
export default function GenderFilters({ resultCount }) {
  const dispatch = useDispatch();
  const { filter_search, filter_deleted } = useSelector((s) => s.genderStore);
  ...
  const activeCount = [filter_search]
    .filter(v => v).length + (filter_deleted ? 1 : 0);
