...
import { clear_filter_store } from '../../../store/footerStore/footerStore';
import { set_filter_store_thunk, get_filter_thunk } from '../../../store/footerStore/footerThunks';
import {
...
export default function FooterFilters({ resultCount }) {
  const dispatch = useDispatch();
  const { filter_search, filter_status, filter_deleted } = useSelector((s) => s.footerStore);
          ...
          >
            <Box sx={{ gridColumn: { xs: '1', sm: '1 / -1', md: '1 / 3' } }}>
              <TextField
                ...
                name="filter_search"
                label="Buscar footer"
                placeholder="Descripción, teléfono o email..."
                value={filter_search}
