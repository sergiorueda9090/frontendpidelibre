...
import { clear_filter_store } from '../../../store/sliderStore/sliderStore';
import { set_filter_store_thunk, get_filter_thunk } from '../../../store/sliderStore/sliderThunks';
import {
...
export default function SliderFilters({ resultCount }) {
  const dispatch = useDispatch();
  const { filter_search, filter_status, filter_deleted } = useSelector((s) => s.sliderStore);
          ...
          >
            ...
            <Box sx={{ gridColumn: { xs: '1', sm: '1 / -1', md: '1 / 3' } }}>
              <TextField
                ...
                name="filter_search"
                label="Buscar slider"
                placeholder="Título o subtítulo..."
                value={filter_search}
