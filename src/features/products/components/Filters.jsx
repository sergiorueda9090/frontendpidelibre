...
import { clear_filter_store } from '../../../store/productsStore/productsStore';
import { set_filter_store_thunk, get_filter_thunk } from '../../../store/productsStore/productsThunks';
import {
...
export default function ProductsFilters({ resultCount }) {
  const dispatch = useDispatch();
  const { filter_search, filter_status, filter_category, filter_deleted } = useSelector((s) => s.productsStore);
